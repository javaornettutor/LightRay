...
namespace NumberConversionNamespace
{
    ...
    public interface NumberConversionSoapType
    {
        ...
        System.Threading.Tasks.Task<NumberConversionNamespace.NumberToWordsResponse> NumberToWordsAsync(NumberConversionNamespace.NumberToWordsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<NumberConversionNamespace.NumberToDollarsResponse> NumberToDollarsAsync(NumberConversionNamespace.NumberToDollarsRequest request);
    }
    ...
    public partial class NumberToWordsRequest
    {
        ...
        public NumberConversionNamespace.NumberToWordsRequestBody Body;
        
        public NumberToWordsRequest()
        {
        }
        
        public NumberToWordsRequest(NumberConversionNamespace.NumberToWordsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToWordsResponse
    {
        ...
        public NumberConversionNamespace.NumberToWordsResponseBody Body;
        
        public NumberToWordsResponse()
        {
        }
        
        public NumberToWordsResponse(NumberConversionNamespace.NumberToWordsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsRequest
    {
        ...
        public NumberConversionNamespace.NumberToDollarsRequestBody Body;
        
        public NumberToDollarsRequest()
        {
        }
        
        public NumberToDollarsRequest(NumberConversionNamespace.NumberToDollarsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsResponse
    {
        ...
        public NumberConversionNamespace.NumberToDollarsResponseBody Body;
        
        public NumberToDollarsResponse()
        {
        }
        
        public NumberToDollarsResponse(NumberConversionNamespace.NumberToDollarsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public interface NumberConversionSoapTypeChannel : NumberConversionNamespace.NumberConversionSoapType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public partial class NumberConversionSoapTypeClient : System.ServiceModel.ClientBase<NumberConversionNamespace.NumberConversionSoapType>, NumberConversionNamespace.NumberConversionSoapType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<NumberConversionNamespace.NumberToWordsResponse> NumberConversionNamespace.NumberConversionSoapType.NumberToWordsAsync(NumberConversionNamespace.NumberToWordsRequest request)
        {
            return base.Channel.NumberToWordsAsync(request);
        }
        
        public System.Threading.Tasks.Task<NumberConversionNamespace.NumberToWordsResponse> NumberToWordsAsync(ulong ubiNum)
        {
            NumberConversionNamespace.NumberToWordsRequest inValue = new NumberConversionNamespace.NumberToWordsRequest();
            inValue.Body = new NumberConversionNamespace.NumberToWordsRequestBody();
            inValue.Body.ubiNum = ubiNum;
            return ((NumberConversionNamespace.NumberConversionSoapType)(this)).NumberToWordsAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<NumberConversionNamespace.NumberToDollarsResponse> NumberConversionNamespace.NumberConversionSoapType.NumberToDollarsAsync(NumberConversionNamespace.NumberToDollarsRequest request)
        {
            return base.Channel.NumberToDollarsAsync(request);
        }
        
        public System.Threading.Tasks.Task<NumberConversionNamespace.NumberToDollarsResponse> NumberToDollarsAsync(decimal dNum)
        {
            NumberConversionNamespace.NumberToDollarsRequest inValue = new NumberConversionNamespace.NumberToDollarsRequest();
            inValue.Body = new NumberConversionNamespace.NumberToDollarsRequestBody();
            inValue.Body.dNum = dNum;
            return ((NumberConversionNamespace.NumberConversionSoapType)(this)).NumberToDollarsAsync(inValue);
        }
